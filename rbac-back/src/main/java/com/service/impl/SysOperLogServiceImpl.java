...
import com.mapper.SysOperLogMapper;
import com.service.SysOperLogService;
...
public class SysOperLogServiceImpl implements SysOperLogService{
    ...
    public Page<SysOperLog> getByPage(Page<SysOperLog> page) {
        com.github.pagehelper.Page<SysOperLog> sysLoginInfoPage= PageHelper.startPage(page.getPageNumber(),page.getPageSize());
